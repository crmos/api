...
use App\Modules\Authentication\Role\Requests\CreateRoleRequest;
use App\Modules\Authentication\Role\Requests\UpdateRoleRequest;
...
class RoleController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->view('acl.role.index', compact('roles'));
    }
    ...
    public function create()
    {
        ...
        return $this->view('acl.role.create');
    }
    ...
    public function show($id)
    {
        ...
        return $this->view('acl.role.show', compact('role'));
    }
    ...
    public function edit($id)
    {
        ...
        $role = $this->roleRepository->findById($id);
        return $this->view('acl.role.edit', compact('role'));
    }
