...
use App\Modules\Authentication\Permission\Repositories\PermissionRepository;
use App\Modules\Authentication\Permission\Requests\CreatePermissionRequest;
use App\Modules\Authentication\Permission\Requests\UpdatePermissionRequest;
...
class PermissionController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->view('acl.permission.index');
    }
    ...
    public function create()
    {
        ...
        return $this->view('acl.permission.create');
    }
    ...
    public function edit($id)
    {
        ...
        return $this->view('acl.permission.edit', compact('permission'));
    }
