...
namespace Crmos\Acl\Providers;

use Illuminate\Support\Facades\Gate;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use Crmos\Acl\Console\PermissionCommand;
use Crmos\Acl\Contracts\Role as RoleContract;
use Crmos\Acl\Models\Role as RoleModel;
use Crmos\Acl\Policies\RolePolicy;
